[
  ...
  { :name => 'Guyana', :iso => 'GY' },
  { :name => 'Haiti', :iso => 'HT' },
  { :name => 'Heard and McDonald Islands', :iso => 'HM' },
  ...
  { :name => 'Mayotte', :iso => 'YT' },
  { :name => 'Mexico', :iso => 'MX', :drawdown => '0.0' },
  ...
  { :name => 'Palau', :iso => 'PW' },
  { :name => 'Palestinian Territory', :iso => 'PS' },
  { :name => 'Panama', :iso => 'PA' },
  { :name => 'Papua New Guinea', :iso => 'PG' },
  { :name => 'Paraguay', :iso => 'PY' },
  { :name => 'Peru', :iso => 'PE', :drawdown => '0.10', :igv => '0.18' },
  ...
  { :name => 'United States', :iso => 'US', :drawdown => '0.0' },
